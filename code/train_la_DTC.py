...
parser.add_argument('--exp_best', type=str,
                    default='LA/DTC_Best', help='model_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs_tanh, outputs = model(volume_batch)  # 4 1 112 112 80
            ...
            consistency_loss = torch.mean((dis_to_mask - outputs_soft) ** 2)                # unsupervised data used
        ...
        # if (iter_num + 1) % 1 == 0:=
            ...
            avg_metric, pred, score = test_show_all_case(model, image_list, num_classes=num_classes,
            ...
            score_2 = torch.tensor(score)[1, :, :, 20:61:10].unsqueeze(0).permute(
                3, 0, 1, 2).repeat(1, 3, 1, 1)
            grid_image = make_grid(score_2, 5, normalize=False)
            writer.add_image('val_results/score2', grid_image, iter_num)
