...
class TwoStreamBatchSampler(Sampler):
    ...
    def __init__(self, primary_indices, secondary_indices, batch_size, secondary_batch_size):
        ...
        self.secondary_batch_size = secondary_batch_size  # batch_size - labeled_bs
        self.primary_batch_size = batch_size - secondary_batch_size  # batch_size - (batch_size - labeled_bs) labeled_bs
