...
from dataloaders.la_heart_pseudo import LAHeart, RandomCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler
...
parser.add_argument('--semi_beta', type=float,  default=0.25,
                    help='balance factor to control regional and sdm loss')
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = (1 - weight_beta) * supervised_loss + weight_beta * semi_loss \
                   + consistency_weight * (consistency_loss_dis + consistency_loss_body_detail) / 2
            ...
            writer.add_scalar('loss/semi_loss',
                              semi_loss, iter_num)
