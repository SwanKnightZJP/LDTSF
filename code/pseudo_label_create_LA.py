...
parser.add_argument('--root_path', type=str,
                    default='../data/2018LA_Seg_Training Set', help='the data for the Supervised training')
parser.add_argument('--pseudo_path', type=str,
                    default='../data/2018LA_Seg_PseudoTraining Set', help='the data for the Semi-Supervised training')

parser.add_argument('--model', type=str,
                    default='/LA/LDC_Tmp', help='the path used to save the tmp model')
parser.add_argument('--model_final', type=str,
                    default='/LA/LDC_Best', help='the path used to save the best model')

parser.add_argument('--tmp_pseudo', type=str, default='LA_pseudo_tmp',
                    help='the path used to save the pseudo label generated by trained LDC model')
parser.add_argument('--final_pseudo', type=str, default='LA_pseudo_final',
                    help='the path used during train LDTSF')

parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')  # TODO  Depends on your device.
...
parser.add_argument('--N_pth', type=int, default=3,
                    help='last N_pth to save in LDC_tmp')
